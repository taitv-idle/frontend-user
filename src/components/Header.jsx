...
import { FaFacebookF, FaLinkedin, FaGithub, FaUser, FaLock, FaList, FaPhoneAlt } from "react-icons/fa";
...
const Header = () => {
    ...
    return (
        <div className='w-full bg-white shadow-sm'>
            {/* Top header section */}
            <div className='bg-gradient-to-r from-blue-50 to-emerald-50 md-lg:hidden'>
                    ...
                    <div className='flex w-full justify-between items-center h-[42px] text-gray-600'>
                        <ul className='flex justify-start items-center gap-6 text-sm'>
                            ...
                            <li className='flex justify-center items-center gap-2'>
                                <IoMdPhonePortrait className="text-emerald-600" />
                        ...
                        <div className='flex justify-center items-center gap-6'>
                            <div className='flex justify-center items-center gap-4'>
                                ...
                                <a href="https://www.linkedin.com/in/tai-truong-van/" className="text-blue-700 hover:text-blue-900 transition-colors"><FaLinkedin /></a>
                                <a href="https://github.com/taitv-idle" className="text-gray-800 hover:text-black transition-colors"><FaGithub /></a>
                            </div>
                            ...
                            <div className='flex group cursor-pointer text-gray-700 text-sm justify-center items-center gap-1 relative mx-4'>
                                ...
                                <ul className='absolute invisible transition-all top-12 rounded-md duration-200 text-gray-800 p-2 w-[100px] flex flex-col gap-2 group-hover:visible group-hover:top-6 group-hover:bg-white group-hover:shadow-md z-10'>
                                    <li className="hover:text-emerald-600 transition-colors">Hindi</li>
                                    <li className="hover:text-emerald-600 transition-colors">English</li>
                                </ul>
                            </div>

                            {userInfo ? (
                                <Link className='flex cursor-pointer justify-center items-center gap-2 text-sm font-medium text-gray-700 hover:text-emerald-600 transition-colors' to='/dashboard'>
                                    <FaUser className="text-emerald-600" />
                                    <span>{userInfo.name}</span>
                                </Link>
                            ) : (
                                <Link to='/login' className='flex cursor-pointer justify-center items-center gap-2 text-sm font-medium text-gray-700 hover:text-emerald-600 transition-colors'>
                    ...
                    <div className='h-[70px] md-lg:h-[80px] flex justify-between items-center flex-wrap'>
                        <div className='md-lg:w-full w-3/12 md-lg:pt-4'>
                            <div className='flex justify-between items-center'>
                                ...
                                <div
                                    className='justify-center items-center w-[36px] h-[36px] bg-gray-100 text-gray-600 rounded-md cursor-pointer lg:hidden md-lg:flex xl:hidden hidden hover:bg-emerald-50 transition-colors'
                        ...
                        <div className='md-lg:w-full w-9/12'>
                            <div className='flex justify-between md-lg:justify-center items-center flex-wrap pl-8'>
                                <ul className='flex justify-start items-start gap-8 text-sm font-medium md-lg:hidden'>
                                    <li>
                                        <Link className={`p-2 block transition-colors ${pathname === '/' ? 'text-emerald-600 font-semibold' : 'text-gray-700 hover:text-emerald-600'}`}>
                                            Home
                                        </Link>
                                    </li>
                                    <li>
                                        <Link to='/shops' className={`p-2 block transition-colors ${pathname === '/shops' ? 'text-emerald-600 font-semibold' : 'text-gray-700 hover:text-emerald-600'}`}>
                                            Shop
                                        </Link>
                                    </li>
                                    <li>
                                        <Link className={`p-2 block transition-colors ${pathname === '/blog' ? 'text-emerald-600 font-semibold' : 'text-gray-700 hover:text-emerald-600'}`}>
                                            Blog
                                        </Link>
                                    </li>
                                    <li>
                                        <Link className={`p-2 block transition-colors ${pathname === '/about' ? 'text-emerald-600 font-semibold' : 'text-gray-700 hover:text-emerald-600'}`}>
                                            About Us
                                        </Link>
                                    </li>
                                    <li>
                                        <Link className={`p-2 block transition-colors ${pathname === '/contact' ? 'text-emerald-600 font-semibold' : 'text-gray-700 hover:text-emerald-600'}`}>
                                            Contact Us
                                        </Link>
                                    </li>
                                </ul>
                                ...
                                <div className='flex md-lg:hidden justify-center items-center gap-5'>
                                    <div className='flex justify-center gap-4'>
                                        <div
                                            ...
                                            className='relative flex justify-center items-center cursor-pointer w-[40px] h-[40px] rounded-full bg-gray-100 hover:bg-emerald-50 transition-colors'
                                        >
                                            <span className='text-lg text-emerald-600'><FaHeart /></span>
                                            {wishlist_count !== 0 && (
                                        ...
                                        <div
                                            ...
                                            className='relative flex justify-center items-center cursor-pointer w-[40px] h-[40px] rounded-full bg-gray-100 hover:bg-emerald-50 transition-colors'
                                        >
                                            <span className='text-lg text-emerald-600'><FaCartShopping /></span>
                ...
                <div className={`w-[280px] z-[9999] transition-all duration-300 fixed ${showSidebar ? '-left-[300px]' : 'left-0 top-0'} overflow-y-auto bg-white h-screen py-6 px-6 shadow-xl`}>
                    <div className='flex justify-start flex-col gap-6'>
                        ...
                        <ul className='flex flex-col justify-start items-start gap-1 text-gray-700 font-medium'>
                            <li className="w-full">
                                <Link className={`py-2 block w-full rounded px-2 transition-colors ${pathname === '/' ? 'text-emerald-600 bg-emerald-50' : 'hover:bg-gray-50'}`}>
                                    Home
                                </Link>
                            </li>
                            <li className="w-full">
                                <Link to='/shops' className={`py-2 block w-full rounded px-2 transition-colors ${pathname === '/shops' ? 'text-emerald-600 bg-emerald-50' : 'hover:bg-gray-50'}`}>
                                    Shop
                                </Link>
                            </li>
                            <li className="w-full">
                                <Link className={`py-2 block w-full rounded px-2 transition-colors ${pathname === '/blog' ? 'text-emerald-600 bg-emerald-50' : 'hover:bg-gray-50'}`}>
                                    Blog
                                </Link>
                            </li>
                            <li className="w-full">
                                <Link className={`py-2 block w-full rounded px-2 transition-colors ${pathname === '/about' ? 'text-emerald-600 bg-emerald-50' : 'hover:bg-gray-50'}`}>
                                    About Us
                                </Link>
                            </li>
                            <li className="w-full">
                                <Link className={`py-2 block w-full rounded px-2 transition-colors ${pathname === '/contact' ? 'text-emerald-600 bg-emerald-50' : 'hover:bg-gray-50'}`}>
                                    Contact Us
                                </Link>
                            </li>
                        </ul>
                        ...
                        <div className='flex justify-start items-center gap-4 text-gray-700 mt-2'>
                            ...
                            <a href="https://www.linkedin.com/in/tai-truong-van/" className="hover:text-blue-700 transition-colors"><FaLinkedin /></a>
                            <a href="https://github.com/taitv-idle" className="hover:text-black transition-colors"><FaGithub /></a>
                        </div>

                        <div className='w-full flex justify-start gap-3 items-center mt-4 bg-gray-50 p-3 rounded-lg'>
                            <div className='w-[42px] h-[42px] rounded-full flex bg-emerald-100 justify-center items-center'>
                                <FaPhoneAlt className="text-emerald-600" />
                            </div>
                            <div className='flex justify-end flex-col'>
                                <h2 className='text-sm font-medium text-gray-800'>+134343455</h2>
                    ...
                    <div className='w-3/12 md-lg:w-full'>
                        <div className='bg-white relative'>
                            <div
                                ...
                                className='h-[50px] bg-emerald-600 hover:bg-emerald-700 transition-colors text-white flex justify-center md-lg:justify-between md-lg:px-6 items-center gap-3 font-medium text-md cursor-pointer rounded-t-md'
                            >
                                ...
                                <ul className='py-2'>
                                    {categorys.map((c, i) => (
                                        <li key={i} className='flex justify-start items-center gap-3 px-5 py-2 hover:bg-gray-50 transition-colors'>
                                            ...
                                            <Link to={`/products?category=${c.name}`} className='text-sm block text-gray-700 hover:text-emerald-600 transition-colors'>{c.name}</Link>
                                        </li>
                                    ))}
                                </ul>
                            </div>
                        ...
                        <div className='flex flex-wrap w-full justify-between items-center md-lg:gap-6'>
                            <div className='w-8/12 md-lg:w-full'>
                                <div className='flex border border-gray-200 h-[50px] items-center relative gap-6 rounded-md overflow-hidden shadow-sm'>
                                    ...
                                    <button
                                        onClick={search}
                                        className='bg-emerald-600 hover:bg-emerald-700 transition-colors right-0 absolute px-8 h-full font-medium text-white flex items-center gap-2'
                                    >
                            ...
                            <div className='w-4/12 block md-lg:hidden pl-4 md-lg:w-full md-lg:pl-0'>
                                <div className='w-full flex justify-end md-lg:justify-start gap-3 items-center'>
                                    ...
                                    <div className='flex justify-end flex-col'>
                                        <h2 className='text-md font-medium text-gray-800'>+1343-43233455</h2>
