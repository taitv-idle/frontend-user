            ...
            <section className="bg-gradient-to-r from-red-400 to-red-500 py-12 mb-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col items-center justify-center text-white">
                        <h2 className="text-3xl font-bold mb-2">Tìm kiếm sản phẩm</h2>
                        ...
                        {searchValue && (
                            <div className="mt-2 text-base text-white/80">Từ khóa: <span className="font-semibold">{searchValue}</span></div>
                        )}
                    </div>
                </div>
            </section>
